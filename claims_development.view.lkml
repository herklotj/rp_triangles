...
select
    ...
    ,rec_reserve AS rec_reserves
    ,ad_inc_rec as ad_incurred_recoveries
    ,tp_inc_rec as tp_incurred_recoveries
    ,pi_inc_rec as pi_incurred_recoveries
    ,ws_inc_rec as ws_incurred_recoveries
    ,ot_inc_rec as ot_incurred_recoveries
    ,ad_inc_rec+tp_inc_rec+pi_inc_rec+ws_inc_rec+ot_inc_rec as total_incurred_recoveries
