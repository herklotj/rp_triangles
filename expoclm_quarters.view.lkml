view: expoclm_quarters {
  ...
  CASE WHEN p.dev_quarter IS NOT NULL THEN a.pi_incurred_cap_50k*p.pi_frequency
    ...
    case when ncdp = 'N' then dec19nm.predicted_ad_freq_an_nm_dec19 else dec19nm.predicted_ad_freq_ap_nm_dec19 end *evy *1.042 *0.95         as predicted_ad_freq_dec19nm,
    case when ncdp = 'N' then dec19nm.predicted_ad_sev_an_nm_dec19 else dec19nm.predicted_ad_sev_ap_nm_dec19 end *evy *1.47 *1.06  *1.17        as predicted_ad_sev_dec19nm,
    case when ncdp = 'N' then dec19nm.predicted_pi_freq_an_nm_dec19 else dec19nm.predicted_pi_freq_ap_nm_dec19 end *evy *0.81 *1.04         as predicted_pi_freq_dec19nm,
    case when ncdp = 'N' then dec19nm.predicted_pi_sev_an_nm_dec19 else dec19nm.predicted_pi_sev_ap_nm_dec19 end *evy *0.91 *1.02          as predicted_pi_sev_dec19nm,
    case when ncdp = 'N' then dec19nm.predicted_tp_freq_an_nm_dec19 else dec19nm.predicted_tp_freq_ap_nm_dec19 end *evy *1.07*0.93          as predicted_tp_freq_dec19nm,
    case when ncdp = 'N' then dec19nm.predicted_tp_sev_an_nm_dec19 else dec19nm.predicted_tp_sev_ap_nm_dec19 end *evy *1.5 *1.06            as predicted_tp_sev_dec19nm,
    case when ncdp = 'N' then dec19nm.predicted_ot_freq_an_nm_dec19 else dec19nm.predicted_ot_freq_ap_nm_dec19 end *evy *1.343 *0.96         as predicted_ot_freq_dec19nm,
    case when ncdp = 'N' then dec19nm.predicted_ot_sev_an_nm_dec19 else dec19nm.predicted_ot_sev_ap_nm_dec19 end *evy *2.183 *0.88           as predicted_ot_sev_dec19nm,
    ...
    case when ncdp = 'N' then dec19nm.predicted_ws_sev_an_nm_dec19 else dec19nm.predicted_ws_sev_ap_nm_dec19 end *evy *1.21 *1.15 *1.03         as predicted_ws_sev_dec19nm,

    case when ncdp = 'N' then dec19m.predicted_ad_freq_an_m_dec19 else dec19m.predicted_ad_freq_ap_m_dec19 end *evy *1.053 *0.96         as predicted_ad_freq_dec19m,
    case when ncdp = 'N' then dec19m.predicted_ad_sev_an_m_dec19 else dec19m.predicted_ad_sev_ap_m_dec19 end *evy *1.47 *1.06 *1.17          as predicted_ad_sev_dec19m,
    case when ncdp = 'N' then dec19m.predicted_pi_freq_an_m_dec19 else dec19m.predicted_pi_freq_ap_m_dec19 end *evy *0.79 *1.04           as predicted_pi_freq_dec19m,
    case when ncdp = 'N' then dec19m.predicted_pi_sev_an_m_dec19 else dec19m.predicted_pi_sev_ap_m_dec19 end *evy *0.913 *1.02           as predicted_pi_sev_dec19m,
    case when ncdp = 'N' then dec19m.predicted_tp_freq_an_m_dec19 else dec19m.predicted_tp_freq_ap_m_dec19 end *evy *1.05 *0.93         as predicted_tp_freq_dec19m,
    case when ncdp = 'N' then dec19m.predicted_tp_sev_an_m_dec19 else dec19m.predicted_tp_sev_ap_m_dec19 end *evy *1.5 *1.06          as predicted_tp_sev_dec19m,
    case when ncdp = 'N' then dec19m.predicted_ot_freq_an_m_dec19 else dec19m.predicted_ot_freq_ap_m_dec19 end *evy *1.29          as predicted_ot_freq_dec19m,
    case when ncdp = 'N' then dec19m.predicted_ot_sev_an_m_dec19 else dec19m.predicted_ot_sev_ap_m_dec19 end *evy *2.23 *0.88           as predicted_ot_sev_dec19m,
    ...
    case when ncdp = 'N' then dec19m.predicted_ws_sev_an_m_dec19 else dec19m.predicted_ws_sev_ap_m_dec19 end *evy *1.21 *1.15 *1.03          as predicted_ws_sev_dec19m,

    case when ncdp = 'N' then jul19nm.predicted_ad_freq_an else jul19nm.predicted_ad_freq_ap end *evy *1.11 *0.95         as predicted_ad_freq_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_ad_sev_an else jul19nm.predicted_ad_sev_ap end *evy *1.57 *1.06 *1.17          as predicted_ad_sev_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_pi_freq_an else jul19nm.predicted_pi_freq_ap end *evy *0.85 *0.99         as predicted_pi_freq_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_pi_sev_an else jul19nm.predicted_pi_sev_ap end *evy *0.86 *1.02           as predicted_pi_sev_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_tpd_freq_an else jul19nm.predicted_tpd_freq_ap end *evy *1.07 *0.93 *1.03        as predicted_tp_freq_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_tpd_sev_an else jul19nm.predicted_tpd_sev_ap end *evy *1.54 *1.06  *1.01           as predicted_tp_sev_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_ot_freq_an else jul19nm.predicted_ot_freq_ap end *evy *2.5         as predicted_ot_freq_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_ot_sev_an else jul19nm.predicted_ot_sev_ap end *evy *1.77 *0.86          as predicted_ot_sev_jul19nm,
    ...
    case when ncdp = 'N' then jul19nm.predicted_ws_sev_an else jul19nm.predicted_ws_sev_ap end *evy * 1.27 *1.15 *1.03        as predicted_ws_sev_jul19nm,
