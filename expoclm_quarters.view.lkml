view: expoclm_quarters {
  ...
  CASE WHEN p.dev_quarter IS NOT NULL THEN a.pi_incurred_cap_50k*p.pi_frequency
    ...
    case when ncdp = 'N' then jul19nm.predicted_ad_sev_an else jul19nm.predicted_ad_sev_ap end *evy *2.081          as predicted_ad_sev_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_pi_freq_an else jul19nm.predicted_pi_freq_ap end *evy *0.949         as predicted_pi_freq_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_pi_sev_an else jul19nm.predicted_pi_sev_ap end *evy *0.912          as predicted_pi_sev_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_tpd_freq_an else jul19nm.predicted_tpd_freq_ap end *evy *1.034        as predicted_tp_freq_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_tpd_sev_an else jul19nm.predicted_tpd_sev_ap end *evy *1.756           as predicted_tp_sev_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_ot_freq_an else jul19nm.predicted_ot_freq_ap end *evy *3.219         as predicted_ot_freq_jul19nm,
    case when ncdp = 'N' then jul19nm.predicted_ot_sev_an else jul19nm.predicted_ot_sev_ap end *evy *1.561          as predicted_ot_sev_jul19nm,
    ...
    case when ncdp = 'N' then jul19nm.predicted_ws_sev_an else jul19nm.predicted_ws_sev_ap end *evy * 1.547        as predicted_ws_sev_jul19nm,
