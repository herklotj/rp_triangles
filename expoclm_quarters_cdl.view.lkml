view: expoclm_quarters_cdl {
  derived_table: {
    ...
    predicted_ad_freq_cdl_apr23 * (CASE WHEN residual_flag_cdl_apr23 = 'Y' THEN predicted_ad_freq_res_cdl_apr23 ELSE 1 end) *evy  as predicted_ad_freq_cdl_apr23,
    predicted_ad_sev_cdl_apr23 * (CASE WHEN residual_flag_cdl_apr23 = 'Y' THEN predicted_ad_sev_res_cdl_apr23 ELSE 1 end) *evy   as predicted_ad_sev_cdl_apr23,
    predicted_ot_freq_cdl_apr23 * (CASE WHEN residual_flag_cdl_apr23 = 'Y' THEN predicted_ot_freq_res_cdl_apr23 ELSE 1 end) *evy   as predicted_ot_freq_cdl_apr23,
    predicted_ot_sev_cdl_apr23 * (CASE WHEN residual_flag_cdl_apr23 = 'Y' THEN predicted_ot_sev_res_cdl_apr23 ELSE 1 end) *evy   as predicted_ot_sev_cdl_apr23,
    predicted_pi_freq_cdl_apr23 * (CASE WHEN residual_flag_cdl_apr23 = 'Y' THEN predicted_pi_freq_res_cdl_apr23 ELSE 1 end) *evy   as predicted_pi_freq_cdl_apr23,
    predicted_pi_sev_cdl_apr23 * (CASE WHEN residual_flag_cdl_apr23 = 'Y' THEN predicted_pi_sev_res_cdl_apr23 ELSE 1 end) *evy   as predicted_pi_sev_cdl_apr23,
    ...
    predicted_ws_freq_cdl_apr23 * (CASE WHEN residual_flag_cdl_apr23 = 'Y' THEN predicted_ws_freq_res_cdl_apr23 ELSE 1 end) *evy   as predicted_ws_freq_cdl_apr23,
