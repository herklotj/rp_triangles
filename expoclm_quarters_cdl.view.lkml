view: expoclm_quarters_cdl {
  derived_table: {
    ...
    predicted_ad_freq_initialcdlmodels,
    predicted_ad_sev_initialcdlmodels,
    predicted_lpi_freq_initialcdlmodels,
    predicted_ot_freq_initialcdlmodels,
    predicted_ot_sev_initialcdlmodels,
    predicted_pi_freq_initialcdlmodels,
    predicted_pi_sev_initialcdlmodels,
    predicted_tpc_freq_initialcdlmodels,
    predicted_tpc_sev_initialcdlmodels,
    predicted_tpo_freq_initialcdlmodels,
    predicted_tpo_sev_initialcdlmodels,
    predicted_ws_freq_initialcdlmodels,
    predicted_ws_sev_initialcdlmodels,
