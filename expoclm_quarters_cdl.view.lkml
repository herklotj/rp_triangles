view: expoclm_quarters_cdl {
  derived_table: {
    ...
    predicted_ad_freq_initialcdlmodels *(CASE WHEN residual_flag = 'Y' THEN predicted_ad_freq_res_202212 ELSE 1 end) *evy  as predicted_ad_freq_initialcdlmodels_adj,
    predicted_ad_sev_initialcdlmodels *(CASE WHEN residual_flag = 'Y' THEN predicted_ad_sev_res_202212 ELSE 1 end) *evy  as predicted_ad_sev_initialcdlmodels_adj,
    predicted_ot_freq_initialcdlmodels *(CASE WHEN residual_flag = 'Y' THEN predicted_ot_freq_res_202212 ELSE 1 end) *evy  as predicted_ot_freq_initialcdlmodels_adj,
    predicted_ot_sev_initialcdlmodels *(CASE WHEN residual_flag = 'Y' THEN predicted_ot_sev_res_202212 ELSE 1 end) *evy  as predicted_ot_sev_initialcdlmodels_adj,
    predicted_pi_freq_initialcdlmodels *(CASE WHEN residual_flag = 'Y' THEN predicted_pi_freq_res_202212 ELSE 1 end) *evy  as predicted_pi_freq_initialcdlmodels_adj,
    predicted_pi_sev_initialcdlmodels *(CASE WHEN residual_flag = 'Y' THEN predicted_pi_sev_res_202212 ELSE 1 end) *evy  as predicted_pi_sev_initialcdlmodels_adj,
    predicted_tpc_freq_initialcdlmodels *evy  as predicted_tpc_freq_initialcdlmodels_adj,
    predicted_tpc_sev_initialcdlmodels *evy  as predicted_tpc_sev_initialcdlmodels_adj,
    predicted_tpo_freq_initialcdlmodels *(CASE WHEN residual_flag = 'Y' THEN predicted_tpo_freq_res_202212 ELSE 1 end) *evy  as predicted_tpo_freq_initialcdlmodels_adj,
    predicted_tpo_sev_initialcdlmodels *(CASE WHEN residual_flag = 'Y' THEN predicted_tpo_sev_res_202212 ELSE 1 end) *evy  as predicted_tpo_sev_initialcdlmodels_adj,
    predicted_ws_freq_initialcdlmodels *(CASE WHEN residual_flag = 'Y' THEN predicted_ws_freq_res_202212 ELSE 1 end) *evy  as predicted_ws_freq_initialcdlmodels_adj,
    predicted_ws_sev_initialcdlmodels *evy  as predicted_ws_sev_initialcdlmodels_adj,
    predicted_lpi_freq_initialcdlmodels *evy  as predicted_lpi_freq_initialcdlmodels_adj,
