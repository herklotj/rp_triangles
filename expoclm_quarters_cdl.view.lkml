view: expoclm_quarters_cdl {
  derived_table: {
    ...
    predicted_ad_freq_initialcdlmodels *evy,
    predicted_ad_sev_initialcdlmodels *evy,
    predicted_lpi_freq_initialcdlmodels *evy,
    predicted_ot_freq_initialcdlmodels *evy,
    predicted_ot_sev_initialcdlmodels *evy,
    predicted_pi_freq_initialcdlmodels *evy,
    predicted_pi_sev_initialcdlmodels *evy,
    predicted_tpc_freq_initialcdlmodels *evy,
    predicted_tpc_sev_initialcdlmodels *evy,
    predicted_tpo_freq_initialcdlmodels *evy,
    predicted_tpo_sev_initialcdlmodels *evy,
    predicted_ws_freq_initialcdlmodels *evy,
    predicted_ws_sev_initialcdlmodels *evy,
