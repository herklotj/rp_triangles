view: expoclm_quarters_cdl {
  derived_table: {
    ...
    predicted_ad_freq_initialcdlmodels *evy  as predicted_ad_freq_initialcdlmodels *1.28,
    predicted_ad_sev_initialcdlmodels *evy  as predicted_ad_sev_initialcdlmodels *1.48,
    predicted_lpi_freq_initialcdlmodels *evy as predicted_lpi_freq_initialcdlmodels *1.00,
    predicted_ot_freq_initialcdlmodels *evy  as predicted_ot_freq_initialcdlmodels *1.44,
    predicted_ot_sev_initialcdlmodels *evy  as predicted_ot_sev_initialcdlmodels *1.45,
    predicted_pi_freq_initialcdlmodels *evy  as predicted_pi_freq_initialcdlmodels *1.17,
    predicted_pi_sev_initialcdlmodels *evy  as predicted_pi_sev_initialcdlmodels *0.94,
    predicted_tpc_freq_initialcdlmodels *evy  as predicted_tpc_freq_initialcdlmodels *1.13,
    predicted_tpc_sev_initialcdlmodels *evy  as predicted_tpc_sev_initialcdlmodels *1.07,
    predicted_tpo_freq_initialcdlmodels *evy  as predicted_tpo_freq_initialcdlmodels *1.10,
    predicted_tpo_sev_initialcdlmodels *evy  as predicted_tpo_sev_initialcdlmodels *1.23,
    predicted_ws_freq_initialcdlmodels *evy  as predicted_ws_freq_initialcdlmodels *0.89,
    predicted_ws_sev_initialcdlmodels *evy  as predicted_ws_sev_initialcdlmodels *1.23,
